...
DONATE_PARAMS = {
    ...
    "cad": {"currency": "cad", "symbol": "$", "presets": "65,30,15,4", "default": "30", "prefix": "true"},
    ...
    "huf": {"currency": "huf", "symbol": "Ft", "presets": "5600,2800,1400,850", "default": "2800", "prefix": "false"},
    "inr": {"currency": "inr", "symbol": "₹", "presets": "1000,500,250,150", "default": "500", "prefix": "true"},
    "jpy": {"currency": "jpy", "symbol": "¥", "presets": "2240,1120,560,340", "default": "1120", "prefix": "true"},
    "mxn": {"currency": "mxn", "symbol": "$", "presets": "400,200,100,60", "default": "200", "prefix": "true"},
    "nok": {"currency": "nok", "symbol": "kr", "presets": "160,80,40,20", "default": "80", "prefix": "false"},
    "pln": {"currency": "pln", "symbol": "zł", "presets": "80,40,20,10", "default": "40", "prefix": "false"},
    "rub": {"currency": "rub", "symbol": "₽", "presets": "1300,800,500,200", "default": "800", "prefix": "false"},
    "sek": {"currency": "sek", "symbol": "kr", "presets": "180,90,45,30", "default": "90", "prefix": "false"},
    "twd": {"currency": "twd", "symbol": "NT$", "presets": "480,240,150,70", "default": "240", "prefix": "true"},
    "usd": {"currency": "usd", "symbol": "$", "presets": "50,30,20,10", "default": "30", "prefix": "true"},
}

# Country codes mapped to currency parameters for Mozilla donation links / form.
DONATE_COUNTRY_CODES = {
    "AD": DONATE_PARAMS["eur"],
    "AT": DONATE_PARAMS["eur"],
    "AX": DONATE_PARAMS["eur"],
    "BE": DONATE_PARAMS["eur"],
    "BL": DONATE_PARAMS["eur"],
    "BR": DONATE_PARAMS["brl"],
    "BV": DONATE_PARAMS["nok"],
    "CA": DONATE_PARAMS["cad"],
    "CY": DONATE_PARAMS["eur"],
    "CZ": DONATE_PARAMS["czk"],
    "DE": DONATE_PARAMS["eur"],
    "DK": DONATE_PARAMS["dkk"],
    "EE": DONATE_PARAMS["eur"],
    "ES": DONATE_PARAMS["eur"],
    "FI": DONATE_PARAMS["eur"],
    "FR": DONATE_PARAMS["eur"],
    "GB": DONATE_PARAMS["gbp"],
    "GF": DONATE_PARAMS["eur"],
    "GL": DONATE_PARAMS["dkk"],
    "GP": DONATE_PARAMS["eur"],
    "GR": DONATE_PARAMS["eur"],
    "HU": DONATE_PARAMS["huf"],
    "IE": DONATE_PARAMS["eur"],
    "IN": DONATE_PARAMS["inr"],
    "IT": DONATE_PARAMS["eur"],
    "JP": DONATE_PARAMS["jpy"],
    "LT": DONATE_PARAMS["eur"],
    "LU": DONATE_PARAMS["eur"],
    "LV": DONATE_PARAMS["eur"],
    "MC": DONATE_PARAMS["eur"],
    "ME": DONATE_PARAMS["eur"],
    "MF": DONATE_PARAMS["eur"],
    "MQ": DONATE_PARAMS["eur"],
    "MT": DONATE_PARAMS["eur"],
    "MX": DONATE_PARAMS["mxn"],
    "NL": DONATE_PARAMS["eur"],
    "NO": DONATE_PARAMS["nok"],
    "PL": DONATE_PARAMS["pln"],
    "PM": DONATE_PARAMS["eur"],
    "PT": DONATE_PARAMS["eur"],
    "RE": DONATE_PARAMS["eur"],
    "RU": DONATE_PARAMS["rub"],
    "SE": DONATE_PARAMS["sek"],
    "SI": DONATE_PARAMS["eur"],
    "SJ": DONATE_PARAMS["nok"],
    "SK": DONATE_PARAMS["eur"],
    "SM": DONATE_PARAMS["eur"],
    "TF": DONATE_PARAMS["eur"],
    "TW": DONATE_PARAMS["twd"],
    "US": DONATE_PARAMS["usd"],
    "VA": DONATE_PARAMS["eur"],
    "YT": DONATE_PARAMS["eur"],
}
